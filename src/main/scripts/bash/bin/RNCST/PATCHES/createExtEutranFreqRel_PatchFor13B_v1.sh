...
# Purpose     : Create exteutranfreq erlations and related eutranfreqs
# Description :
# Date        : 2013.03.26
# Who         : Fatih ONUR
##############################################
...
usage(){
  ...
  echo "  e.g. $0 1"
  echo ""
  echo "HELP: This script delete Inter,Ext relations and related ExttUCs"
  echo ""
  exit 1
}
...
rncName=`printf "RNC%02d" $rncCount`
moFileName="${rncName}-v13_createExtEutranFreqRelv1.mo"
moFileTarget="/tmp/${moFileName}"
moFileSource="/netsim/simgen3/13B_ST50K/bin/RNCST/JAVAFILES/EXTEUTRANFREQREL/$moFileName"

...
#netsimlin355_list="RNC42 RNC43 RNC44 RNC45 RNC46 RNC47 RNC48"
...
#
#SCRIPTS="deleteGsmRelations_Proxy_Patch13A.sh;"
SCRIPTS="updateUtranCellURA_PatchFor13B.sh;"\

...
# Purpose     : Delete LA/SA/RA
# Description : LA and SA
# Date        : 06 09 2012
# Who         : RESHMA
##############################################
...
do
  ...
  echo '(' >> $MOSCRIPT
  echo '  mo "ManagedElement=1,RncFunction=1,LocationArea='$LACOUNT'"' >> $MOSCRIPT
  echo '  exception none' >> $MOSCRIPT
  echo ')' >> $MOSCRIPT
 
  echo 'DELETE' >> $MOSCRIPT
  echo '(' >> $MOSCRIPT
  echo '  mo "ManagedElement=1,RncFunction=1,Ura='$LACOUNT'"' >> $MOSCRIPT
  echo '  exception none' >> $MOSCRIPT
  echo ')' >> $MOSCRIPT

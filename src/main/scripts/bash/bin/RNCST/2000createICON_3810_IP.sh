...
do  
  ...
  echo ' identity 1' >> $MOSCRIPT
  echo ' moType EthernetSwitch' >> $MOSCRIPT
  echo ' exception none' >> $MOSCRIPT
  echo ' nrOfAttributes 0' >> $MOSCRIPT
  echo ')' >> $MOSCRIPT
  ...
  do
    ...
    EthernetSwitch_systemPort=false
    if [ $COUNTX -eq 1 ]
    then
       EthernetSwitch_systemPort=true
    fi
    ...
    echo 'CREATE' >> $MOSCRIPT
    echo '(' >> $MOSCRIPT
    echo '  parent "ManagedElement=1,Equipment=1,Subrack=MS,Slot='$COUNT',PlugInUnit=1,ExchangeTerminalIp=1,EthernetSwitch=1"' >> $MOSCRIPT
    echo ' identity '$COUNTX >> $MOSCRIPT
    echo ' moType EthernetSwitchPort' >> $MOSCRIPT
    echo ' exception none' >> $MOSCRIPT
    echo ' nrOfAttributes 1' >> $MOSCRIPT
    echo 'systemPort Boolean '$EthernetSwitch_systemPort >> $MOSCRIPT
    echo ')' >> $MOSCRIPT
  ...
  echo '  parent "ManagedElement=1,Equipment=1,Subrack=MS,Slot='$COUNT',PlugInUnit=1,ExchangeTerminalIp=1"' >> $MOSCRIPT
  echo ' identity 1' >> $MOSCRIPT
  echo ' moType InternalEthernetPort' >> $MOSCRIPT
  echo ' exception none' >> $MOSCRIPT
  echo ' nrOfAttributes 1' >> $MOSCRIPT
  echo 'ethernetSwitchRef Ref "ManagedElement=1,Equipment=1,Subrack=MS,Slot='$COUNT',PlugInUnit=1,ExchangeTerminalIp=1,EthernetSwitch=1" ' >> $MOSCRIPT
  echo ')' >> $MOSCRIPT
  ...
  echo 'CREATE' >> $MOSCRIPT
  echo '(' >> $MOSCRIPT
  echo '  parent "ManagedElement=1,Equipment=1,Subrack=MS,Slot='$COUNT',PlugInUnit=1,ExchangeTerminalIp=1,InternalEthernetPort=1"' >> $MOSCRIPT
  echo ' identity 1' >> $MOSCRIPT
  ...
  echo 'SET' >> $MOSCRIPT
  echo '(' >> $MOSCRIPT
  echo '  mo "ManagedElement=1,Equipment=1,Subrack=MS,Slot='$COUNT',PlugInUnit=1,ExchangeTerminalIp=1,InternalEthernetPort=1,IpInterface=1"' >> $MOSCRIPT
  ...
  echo "IPACCESSHOSTET($IPACCESSHOSTCOUNT)_ipAddress="$IPACCESSHOSTET_ipAddress
  ...
  echo ' exception none' >> $MOSCRIPT
  echo ' nrOfAttributes 1' >> $MOSCRIPT
  echo ' ipInterfaceMoRef Ref "ManagedElement=1,Equipment=1,Subrack=MS,Slot='$COUNT',PlugInUnit=1,ExchangeTerminalIp=1,InternalEthernetPort=1,IpInterface=1"' >> $MOSCRIPT

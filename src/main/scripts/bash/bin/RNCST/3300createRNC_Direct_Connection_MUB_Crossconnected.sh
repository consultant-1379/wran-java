...
echo '   moType Aal5CrossConnection' >> $MOSCRIPT
echo '   exception none' >> $MOSCRIPT
echo '   nrOfAttributes 0' >> $MOSCRIPT
echo ')' >> $MOSCRIPT
...
COUNT2=`expr $COUNT2 + 1`
 ...
 in
   ...
   7) ID=b"$COUNT"ma; VCLID='"ManagedElement=1,TransportNetwork=1,AtmPort=MS-24-1,VplTp=vp'$COUNT',VpcTp=1,VclTp=vc32"';;
8) ID=b"$COUNT"ma-cc; VCLID='"ManagedElement=1,TransportNetwork=1,AtmPort=MS-24-1,VplTp=vp'$COUNT',VpcTp=1,VclTp=vc33"';;
9) ID=b"$COUNT"mb; VCLID='"ManagedElement=1,TransportNetwork=1,AtmPort=MS-27-1,VplTp=vp'$COUNT',VpcTp=1,VclTp=vc32-cc"';;
10) ID=b"$COUNT"mb-cc; VCLID='"ManagedElement=1,TransportNetwork=1,AtmPort=MS-27-2,VplTp=vp'$COUNT',VpcTp=1,VclTp=vc33-cc"';;
...
#Adding MoRef for Aal5CrossConnection
echo 'SET' >> $MOSCRIPT
echo '(' >> $MOSCRIPT
echo '  mo "ManagedElement=1,TransportNetwork=1,Aal5CrossConnection=b'$COUNT'ia"' >> $MOSCRIPT
echo '   nrOfAttributes 2' >> $MOSCRIPT
echo '   aal5TpVccTpBRef Ref "ManagedElement=1,TransportNetwork=1,Aal5TpVccTp=b'$COUNT'mb"' >> $MOSCRIPT
echo '   aal5TpVccTpARef Ref "ManagedElement=1,TransportNetwork=1,Aal5TpVccTp=b'$COUNT'ma"' >> $MOSCRIPT
echo ')' >> $MOSCRIPT

echo 'SET' >> $MOSCRIPT
echo '(' >> $MOSCRIPT
echo '  mo "ManagedElement=1,TransportNetwork=1,Aal5CrossConnection=b'$COUNT'ib"' >> $MOSCRIPT
echo '   nrOfAttributes 2' >> $MOSCRIPT
echo '   aal5TpVccTpBRef Ref "ManagedElement=1,TransportNetwork=1,Aal5TpVccTp=b'$COUNT'mb-cc"' >> $MOSCRIPT
echo '   aal5TpVccTpARef Ref "ManagedElement=1,TransportNetwork=1,Aal5TpVccTp=b'$COUNT'ma-cc"' >> $MOSCRIPT
echo ')' >> $MOSCRIPT

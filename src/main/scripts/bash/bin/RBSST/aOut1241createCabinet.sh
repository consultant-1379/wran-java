...
#fi
  ...
  #  do
    ...
    do
     ...
     echo '(' >> $MOSCRIPT$MOFILEEXTENSION
     echo "  mo \"ManagedElement=1,Equipment=1,AuxPlugInUnit=$YCOUNT\"" >> $MOSCRIPT$MOFILEEXTENSION
     echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
     echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
     echo "   positionRef Ref \"ManagedElement=1,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
     echo ')' >> $MOSCRIPT$MOFILEEXTENSION
...
#     CABID="CABID_"$ID
   ...
   # echo "     sharedCabinetIdentifier String "$RBSCOUNT >> $MOSCRIPT$MOFILEEXTENSION
    ...
    echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
    echo '(' >> $MOSCRIPT$MOFILEEXTENSION
    echo '  mo "ManagedElement=1,Equipment=1,HwUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
    echo "   positionRef Ref \"ManagedElement=1,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
    echo ')' >> $MOSCRIPT$MOFILEEXTENSION
   ...
   # echo "     sharedCabinetIdentifier String "$RBSCOUNT >> $MOSCRIPT$MOFILEEXTENSION
    ...
    echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
    echo '(' >> $MOSCRIPT$MOFILEEXTENSION
    echo '  mo "ManagedElement=1,Equipment=1,Subrack=1,Slot=4,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
    echo "   positionRef Ref \"ManagedElement=1,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
    echo ')' >> $MOSCRIPT$MOFILEEXTENSION
    ...
    echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
    echo '(' >> $MOSCRIPT$MOFILEEXTENSION
    echo '  mo "ManagedElement=1,Equipment=1,Subrack=1,Slot=24,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
    echo "   positionRef Ref \"ManagedElement=1,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
    echo ')' >> $MOSCRIPT$MOFILEEXTENSION
...
#    CABID="CABID_"$ID
   ...
   # echo "     sharedCabinetIdentifier String "$RBSCOUNT >> $MOSCRIPT$MOFILEEXTENSION
    ...
    echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
    echo '(' >> $MOSCRIPT$MOFILEEXTENSION
    echo '  mo "ManagedElement=1,Equipment=1,Subrack=1,Slot=DUW,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
    echo "   positionRef Ref \"ManagedElement=1,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
    echo ')' >> $MOSCRIPT$MOFILEEXTENSION
   ...
   # echo "     sharedCabinetIdentifier String "$RBSCOUNT >> $MOSCRIPT$MOFILEEXTENSION
    ...
    echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
    echo '(' >> $MOSCRIPT$MOFILEEXTENSION
    echo '  mo "ManagedElement=1,Equipment=1,Subrack=1,Slot=ET-MFX,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
    echo "   positionRef Ref \"ManagedElement=1,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
    echo ')' >> $MOSCRIPT$MOFILEEXTENSION
    ...
    echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
    echo '(' >> $MOSCRIPT$MOFILEEXTENSION
    echo '  mo "ManagedElement=1,Equipment=1,Subrack=1,Slot=CBU,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
    echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
    echo "   positionRef Ref \"ManagedElement=1,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
    echo ')' >> $MOSCRIPT$MOFILEEXTENSION

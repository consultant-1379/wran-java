...
MOSCT
     ...
     then
          ...
          echo  "${IPHOSTLINK_ipv4Addresses[0]}" 
      fi

cat >> $MOSCRIPT$MOFILEEXTENSION << MOSCT
          ipInterfaceMoRef Ref "ManagedElement=1,Equipment=1,Subrack=1,Slot=DUW,PlugInUnit=1,ExchangeTerminalIp=1,GigaBitEthernet=1,IpInterface=2"
     )
    ...
    SET
    (
      mo "ManagedElement=1,Equipment=1,Subrack=1,Slot=DUW,PlugInUnit=1,ExchangeTerminalIp=1,GigaBitEthernet=1,IpInterface=2"
       identity 1
       exception none
       nrOfAttributes 1
         userLabel String ICON

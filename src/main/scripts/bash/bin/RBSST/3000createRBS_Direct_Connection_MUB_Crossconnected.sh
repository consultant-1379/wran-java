...
#                 changes RBS to be the same as unique RBS with IpAtmLinks.
# Date        : 25 FEB 2013
# Who         : Rob Guinan
...
#echo '   uses Ref "ManagedElement=1,Equipment=1,Subrack=1,Slot=1,PlugInUnit=1,ExchangeTerminal=ET-MFG,Os155SpiTtp=ta1,Sts3CspeTtp=ta1"' >> $MOSCRIPT$MOFILEEXTENSION
echo ')' >> $MOSCRIPT$MOFILEEXTENSION
...
echo '(' >> $MOSCRIPT$MOFILEEXTENSION
echo '  parent "ManagedElement=1,TransportNetwork=1"' >> $MOSCRIPT$MOFILEEXTENSION
echo '   identity b'$COUNT'a1' >> $MOSCRIPT$MOFILEEXTENSION
...
echo '(' >> $MOSCRIPT$MOFILEEXTENSION
echo '  parent "ManagedElement=1,TransportNetwork=1"' >> $MOSCRIPT$MOFILEEXTENSION
echo '   identity b'$COUNT'a2' >> $MOSCRIPT$MOFILEEXTENSION
echo '   moType Aal2PathVccTp' >> $MOSCRIPT$MOFILEEXTENSION
echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
echo '   nrOfAttributes 0' >> $MOSCRIPT$MOFILEEXTENSION
echo ')' >> $MOSCRIPT$MOFILEEXTENSION
...
echo '  parent "ManagedElement=1,IpOam=1,Ip=1"' >> $MOSCRIPT$MOFILEEXTENSION
echo '   identity 1'  >> $MOSCRIPT$MOFILEEXTENSION
echo '   moType IpRoutingTable' >> $MOSCRIPT$MOFILEEXTENSION
echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
...
echo '   aal2PathVccTpList Array Ref 2' >> $MOSCRIPT$MOFILEEXTENSION
...
echo 'SET'  >> $MOSCRIPT$MOFILEEXTENSION
echo '(' >> $MOSCRIPT$MOFILEEXTENSION
echo 'mo "ManagedElement=1,TransportNetwork=1,Aal2Sp=1"' >> $MOSCRIPT$MOFILEEXTENSION
echo ' exception none' >> $MOSCRIPT$MOFILEEXTENSION
echo ' nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
echo '  a2ea String "'$COUNT'AFaf09"' >> $MOSCRIPT$MOFILEEXTENSION
echo ')' >> $MOSCRIPT$MOFILEEXTENSION

echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
echo '(' >> $MOSCRIPT$MOFILEEXTENSION
echo '  mo "ManagedElement=1,NodeBFunction=1,Iub=1,NbapCommon=1"' >> $MOSCRIPT$MOFILEEXTENSION
echo '  exception none' >> $MOSCRIPT$MOFILEEXTENSION
echo '  nrOfAttributes 2' >> $MOSCRIPT$MOFILEEXTENSION
echo '  "uniSaalTpRef2" Ref "ManagedElement=1,TransportNetwork=1,UniSaalTp=b'$COUNT'ca"' >> $MOSCRIPT$MOFILEEXTENSION
echo '  "uniSaalTpRef1" Ref "ManagedElement=1,TransportNetwork=1,UniSaalTp=b'$COUNT'cb"' >> $MOSCRIPT$MOFILEEXTENSION
echo ')' >> $MOSCRIPT$MOFILEEXTENSION


echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
echo '(' >> $MOSCRIPT$MOFILEEXTENSION
echo '  mo "ManagedElement=1,NodeBFunction=1,Iub=1,NbapDedicated=1"' >> $MOSCRIPT$MOFILEEXTENSION
echo '  exception none' >> $MOSCRIPT$MOFILEEXTENSION
echo '  nrOfAttributes 2' >> $MOSCRIPT$MOFILEEXTENSION
echo '  "uniSaalTpRef2" Ref "ManagedElement=1,TransportNetwork=1,UniSaalTp=b'$COUNT'da"' >> $MOSCRIPT$MOFILEEXTENSION
echo '  "uniSaalTpRef1" Ref "ManagedElement=1,TransportNetwork=1,UniSaalTp=b'$COUNT'db"' >> $MOSCRIPT$MOFILEEXTENSION
echo ')' >> $MOSCRIPT$MOFILEEXTENSION
...
echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
echo '(' >> $MOSCRIPT$MOFILEEXTENSION
echo '  mo "ManagedElement=1,IpOam=1,Ip=1,IpAtmLink=1"' >> $MOSCRIPT$MOFILEEXTENSION
echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
echo '   nrOfAttributes 2' >> $MOSCRIPT$MOFILEEXTENSION
echo '   subnetMask  String 255.255.5.3'  >> $MOSCRIPT$MOFILEEXTENSION
echo '   ipAddress  String 10.2.4.5'  >> $MOSCRIPT$MOFILEEXTENSION

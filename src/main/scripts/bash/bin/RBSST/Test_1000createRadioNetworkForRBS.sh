...
### VERSION HISTORY
##################################################
# Ver1 (ENM)  : Modified for 17.12 ENM
# Purpose     : To Create Pm mo instances for RBS
# Description : Added sector mo files
# Date        : 07 JULY 2017
# Who         : Harish Dunga
##################################################
...
cat "$SIMDIR/mo/$RBSDIR/sector.mo" >> $MOSCRIPT
...
#./1126createAtmPort.sh $SIMNAME $ENV $RNCIDCOUNT
#./1180createTNMOs.sh $SIMNAME $ENV $RNCIDCOUNT

...
Usage  : $0  <env file> <rnc num>

Example: $0 O12-ST-12.0.7-N.env 1
...
echo "rm $MOSCRIPT$MOFILEEXTENSION " >> $DELETE_ALL_MO_SCRIPTS # Script to clean up all the generated MO scripts

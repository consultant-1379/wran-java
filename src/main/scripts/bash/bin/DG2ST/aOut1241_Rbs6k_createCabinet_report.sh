...
do
 ...
 #  12) NUMOFSECTOR=6; NUMOFCARRIER=2;;
  ...
  then
    ...
    do
     #echo "  :: ExternalMode="$COUNT_EM
      ...
      echo '  parent "ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1"' >> $MOSCRIPT$MOFILEEXTENSION	  
      ...
      echo '  externalNodeId String '$COUNT_EM >> $MOSCRIPT$MOFILEEXTENSION
      echo ')' >> $MOSCRIPT$MOFILEEXTENSION
  ...
  #  while [ "$YCOUNT" -le 6 ]
  #  do
#echo "inside $MULTICABINET_START"
     echo 'CREATE' >> $MOSCRIPT$MOFILEEXTENSION
     echo '(' >> $MOSCRIPT$MOFILEEXTENSION
     echo '  parent "ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1"' >> $MOSCRIPT$MOFILEEXTENSION
    ...
    while [ "$YCOUNT" -le $NUMOFSECTOR ]
    do

     echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
     echo '(' >> $MOSCRIPT$MOFILEEXTENSION
     echo '  mo ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1,FieldReplaceableUnit='$YCOUNT >> $MOSCRIPT$MOFILEEXTENSION
     echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
     echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
     echo "   positionRef Ref \"ManagedElement=$RNCNAME$RBSNAME$COUNT,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
     echo ')' >> $MOSCRIPT$MOFILEEXTENSION

#     ID=`expr $ID + $INCREMENT`
#     CABID="CABID_"$ID
...
#FieldReplaceableUnit 
     echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
     echo '(' >> $MOSCRIPT$MOFILEEXTENSION
     echo '  mo ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1,FieldReplaceableUnit=1' >> $MOSCRIPT$MOFILEEXTENSION
     echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
     echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
     echo "   climateZoneRef Ref \"ManagedElement=$RNCNAME$RBSNAME$COUNT,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
     echo ')' >> $MOSCRIPT$MOFILEEXTENSION  

 #   echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo '(' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo '  mo "ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1,HwUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo "   positionRef Ref \"ManagedElement=$RNCNAME$RBSNAME$COUNT,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
 #   echo ')' >> $MOSCRIPT$MOFILEEXTENSION
    ...
    if ([ "$RNCCOUNT" -ge 4 ] && [ "$RNCCOUNT" -le 53 ]) || ([ "$RNCCOUNT" -ge 107 ] && [ "$RNCCOUNT" -le 108 ])
   then
 echo "$RNCNAME$RBSNAME$COUNT $TYPE ID=$CABID MIXEDMODE="$MIXEDMODE
   echo 'CREATE' >> $MOSCRIPT$MOFILEEXTENSION
    echo '(' >> $MOSCRIPT$MOFILEEXTENSION
  ...
  XCOUNT=1
   while [[ "$XCOUNT" -le "$NUMOFSECTOR" && "$XCOUNT" -le 2 ]]
    do

     echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
     echo '(' >> $MOSCRIPT$MOFILEEXTENSION
     echo '  mo ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1,FieldReplaceableUnit='$XCOUNT >> $MOSCRIPT$MOFILEEXTENSION
     echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
     echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
     echo "   positionRef Ref \"ManagedElement=$RNCNAME$RBSNAME$COUNT,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
     echo ')' >> $MOSCRIPT$MOFILEEXTENSION
  ...
  #  echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '(' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '  mo "ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1,Subrack=1,Slot=4,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo "   positionRef Ref \"ManagedElement=$RNCNAME$RBSNAME$COUNT,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
  #  echo ')' >> $MOSCRIPT$MOFILEEXTENSION
  ...
  #  echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '(' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '  mo "ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1,Subrack=1,Slot=24,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo "   positionRef Ref \"ManagedElement=$RNCNAME$RBSNAME$COUNT,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
  #  echo ')' >> $MOSCRIPT$MOFILEEXTENSION
...
#    CABID="CABID_"$ID
    ...
    if [ "$RNCCOUNT" -ge 66 ] && [ "$RNCCOUNT" -le 103 ]
   then
 ...
 echo "$RNCNAME$RBSNAME$COUNT $TYPE ID=$CABID MIXEDMODE="$MIXEDMODE
   echo 'CREATE' >> $MOSCRIPT$MOFILEEXTENSION
    ...
    echo "     cabinetId String "$CABID >>  $MOSCRIPT$MOFILEEXTENSION
    echo "     cabinetIdentifier String "$CABID >>  $MOSCRIPT$MOFILEEXTENSION
   # echo "     sharedcabinetIdentifier String "$RBSCOUNT >> $MOSCRIPT$MOFILEEXTENSION
    echo ')' >> $MOSCRIPT$MOFILEEXTENSION
 ...
 #   echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo '(' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo '  mo "ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1,Subrack=1,Slot=DUW,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
 #   echo "   positionRef Ref \"ManagedElement=$RNCNAME$RBSNAME$COUNT,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
 #   echo ')' >> $MOSCRIPT$MOFILEEXTENSION
    ...
    if ([ "$RNCCOUNT" -ge 54 ] && [ "$RNCCOUNT" -le 65 ]) || ([ "$RNCCOUNT" -ge 104 ] && [ "$RNCCOUNT" -le 105 ]) || ([ "$RNCCOUNT" == 109 ])
   then
  echo "$RNCNAME$RBSNAME$COUNT $TYPE ID=$CABID MIXEDMODE="$MIXEDMODE 
  ...
  #  echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '(' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '  mo "ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1,Subrack=1,Slot=ET-MFX,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo "   positionRef Ref \"ManagedElement=$RNCNAME$RBSNAME$COUNT,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
  #  echo ')' >> $MOSCRIPT$MOFILEEXTENSION
  ...
  #  echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '(' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '  mo "ManagedElement='$RNCNAME$RBSNAME$COUNT',Equipment=1,Subrack=1,Slot=CBU,PlugInUnit=1"' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo '   nrOfAttributes 1' >> $MOSCRIPT$MOFILEEXTENSION
  #  echo "   positionRef Ref \"ManagedElement=$RNCNAME$RBSNAME$COUNT,Equipment=1,Cabinet=$CABID\"" >> $MOSCRIPT$MOFILEEXTENSION
  #  echo ')' >> $MOSCRIPT$MOFILEEXTENSION
  ...
  then
   ...
   while [ "$XCOUNT" -le "$NUMOFSECTOR" ]
    do
      ...
      echo 'SET' >> $MOSCRIPT$MOFILEEXTENSION
      echo '(' >> $MOSCRIPT$MOFILEEXTENSION
      echo '  mo ManagedElement='$RNCNAME$RBSNAME$COUNT',NodeSupport=1,SectorEquipmentFunction='$XCOUNT >> $MOSCRIPT$MOFILEEXTENSION
      echo '    mixedModeRadio Boolean '$MIXEDMODE  >> $MOSCRIPT$MOFILEEXTENSION
      echo ')' >> $MOSCRIPT$MOFILEEXTENSION
